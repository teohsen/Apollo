    ...
    def generateMatrix(self, n):
        ...
        while left <= right and top <= down:
            ...
            for i in range(right, left - 1,
                           -1):  # from left to right, in reverse order. left-1 to reach the leftmost position in a row
                matrix[down][i] = num
                num += 1  # update num
            ...
            for i in range(down, top - 1,
                           -1):  # from bottom to top, in reverse order. top-1 to reach the topmost position in a col
